...
typedef enum
{
  ...
  CFG_TASK_ADV_CANCEL_ID,
	CFG_TASK_SEND_NOTIF_ID_CUPS_SETPOINT_P2_RW,
	CFG_TASK_SEND_NOTIF_ID_TS_TEST_STATUS,
	CFG_TASK_SEND_NOTIF_ID_TS_TEST_RESP_CODE,
	CFG_TASK_SEND_NOTIF_ID_CS_FLOWTEMP,
  CFG_TASK_SEND_NOTIF_ID_CS_P2T2,
  CFG_TASK_SEND_NOTIF_ID_CS_P1T1,
  CFG_TASK_SEND_NOTIF_ID_CS_UNIT_P2T2,
  CFG_TASK_SEND_NOTIF_ID_CS_UNIT_P1T1,
  CFG_TASK_SEND_NOTIF_ID_CS_MOD_COM_ERROR,
  CFG_TASK_SEND_NOTIF_ID_CS_DIAG_ERROR,
  CFG_TASK_SEND_NOTIF_ID_CS_DIAG_WARN,
  CFG_TASK_SEND_NOTIF_ID_CS_INLET_PRES_PD1,
  CFG_TASK_SEND_NOTIF_ID_CS_OUTLET_PRES_PD2,
  CFG_TASK_SEND_NOTIF_ID_CS_OPENING_PER,
  CFG_TASK_SEND_NOTIF_ID_CS_OPERATION_MODE,
  CFG_TASK_SEND_NOTIF_ID_CS_LVDT_AMP,
//  CFG_TASK_SEND_NOTIF_ID_CS_TOTALIZER,
//  CFG_TASK_SEND_NOTIF_ID_CS_TIME_STAMP_HHMM,
//  CFG_TASK_SEND_NOTIF_ID_CS_TIME_STAMP_DDMM,
//  CFG_TASK_SEND_NOTIF_ID_CS_YEAR_STAMP_YYYY,
//  CFG_TASK_SEND_NOTIF_ID_CS_TOTALIZER_LAST_VAL,
//  CFG_TASK_SEND_NOTIF_ID_CS_TOTALIZER_UNIT,
	CFG_TASK_SEND_NOTIF_ID_CS_CALIB_STATUS,
	CFG_TASK_SEND_NOTIF_ID_CS_CALIB_RESP_CODE,
	CFG_TASK_SEND_NOTIF_ID_CS_CALIB_RESERVED,
